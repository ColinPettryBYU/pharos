  ...
  return (
    <div className="relative flex min-h-[calc(100vh-4rem)] items-center justify-center p-4">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-40 -left-40 h-[450px] w-[450px] rounded-full blur-[120px]" style={{ background: "rgba(245,184,184,0.14)" }} />
        <div className="absolute -bottom-20 -right-20 h-72 w-72 rounded-full blur-3xl" style={{ background: "rgba(176,196,216,0.13)" }} />
        <div className="absolute top-1/3 right-1/4 h-80 w-80 rounded-full blur-[100px]" style={{ background: "rgba(176,196,216,0.07)" }} />
      </div>
      ...
      >
        <Card className="border-border/60 shadow-xl overflow-hidden">
          {/* Colored top bar */}
          <div className="h-1 w-full" style={{ background: "linear-gradient(to right, var(--pharos-blush), var(--pharos-sky), var(--pharos-blush))" }} />
          ...
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription>Join Pharos and make a difference</CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="displayName" placeholder="Your full name" className="pl-9" {...register("displayName")} />
                </div>
