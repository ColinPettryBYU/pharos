...
export default function ImpactDashboard() {
  ...
  const impactStats = [
    { label: "Residents Served", value: summary?.totalResidents ?? 60, icon: Users, suffix: "+", color: "text-blue-500", bg: "bg-blue-500/10" },
    { label: "Education Progress", value: summary?.avgEducationProgress ?? 78, icon: GraduationCap, suffix: "%", color: "text-emerald-500", bg: "bg-emerald-500/10" },
    { label: "Avg Health Score", value: summary?.avgHealthScore ?? 4.2, icon: HeartPulse, color: "text-rose-500", bg: "bg-rose-500/10" },
    { label: "Active Safehouses", value: summary?.totalSafehouses ?? 9, icon: Building2, color: "text-amber-500", bg: "bg-amber-500/10" },
  ];
