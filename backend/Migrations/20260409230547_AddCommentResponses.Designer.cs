...
namespace Pharos.Api.Migrations
{
    ...
    [Migration("20260409230547_AddCommentResponses")]
    partial class AddCommentResponses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pharos.Api.Models.ChatConversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Pharos.Api.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Pharos.Api.Models.CommentResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("comment_responses", (string)null);
                });
            ...
            modelBuilder.Entity("Pharos.Api.Models.ResidentElevatedRiskScore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("TopFactors")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)")
                        .HasColumnName("top_factors");

                    b.HasKey("Id");

                    b.ToTable("resident_elevated_risk_scores", (string)null);
                });
            ...
            modelBuilder.Entity("Pharos.Api.Models.SocialMediaCredential", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("social_media_credentials", (string)null);
                });
            ...
            modelBuilder.Entity("Pharos.Api.Models.ChatMessage", b =>
                {
                    b.HasOne("Pharos.Api.Models.ChatConversation", "Conversation")
                        .WithMany("Messages")
